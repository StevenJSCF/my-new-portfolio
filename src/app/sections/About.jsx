...
const About = () => {
  ...
  return (
    <Fragment>
<section
  className='min-h-[100vh] border-none shadow-zinc-300 dark:shadow-zinc-700 shadow-sm overflow-x-hidden'
  id='about'
  ref={aboutRef}
>
  <div
          ...
          >
            ...
            <div className='mt-5 justify-evenly text-justify'>
              <p className='text-gray-600 dark:text-gray-300'>
                ...
                a Software Engineer at Iowa State University. I was born and raised in
                Lara, Venezuela. I am a very passionate person about technology
                and software development. development, I tend to have an inclination
                towards backend development, as is what I have been mostly exposed to. 
                However, I love to learn new things and I am always looking for new challenges.
              </p>
            </div>
          </div>
        </div>
